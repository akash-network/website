...
<CommunityHero
  ...
  buttonLink="https://akashedu.thinkific.com/products/courses/akashedu"
/>
...
<div className="flex flex-col  not-prose  justify-center items-center">
  ...
  <ButtonLink arrow className="mt-10 " link="https://akashedu.thinkific.com/products/courses/akashedu" variant="secondary" size="lg" >
Start Learning
  </ButtonLink>
</div>
