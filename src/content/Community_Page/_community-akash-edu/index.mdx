...
<ButtonLink className="not-prose" variant="secondary" size="lg"
 link ="https://akashnet.typeform.com/to/Ep5qnwV1?typeform-source=akash.network"
>
  <svg
  class="text-para"
  stroke = "currentColor"
   width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M7.64062 12.3573L12.3547 7.64319M12.3547 7.64319H8.22988M12.3547 7.64319V11.768"  stroke-linecap="round" stroke-linejoin="round"/>
<path d="M9.9974 18.3333C14.5997 18.3333 18.3307 14.6023 18.3307 9.99996C18.3307 5.39758 14.5997 1.66663 9.9974 1.66663C5.39502 1.66663 1.66406 5.39758 1.66406 9.99996C1.66406 14.6023 5.39502 18.3333 9.9974 18.3333Z"  stroke-linecap="round" stroke-linejoin="round"/>
</svg>
