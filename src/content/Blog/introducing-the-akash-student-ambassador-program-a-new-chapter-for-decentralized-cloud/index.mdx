...
> **TL;DR:** Akash launched its Student Ambassador Program with inaugural cohorts from Princeton, Cornell, USC, and UT Austin — students who build, publish, and present on decentralized cloud infrastructure to drive ecosystem adoption on campuses across the U.S.
...
A program bringing Akash to U.S. campuses by recruiting student builders and community catalysts who spread awareness, host events, publish technical content, and drive ecosystem adoption as co-creators.

**Who is in the first cohort?**
Students from Princeton University, Cornell University, University of Southern California (USC), and UT Austin — drawn by interests in decentralized infrastructure, AI, blockchain, and cryptography.

**What do student ambassadors do?**
Publish monthly content (YouTube tutorials, blog posts, X threads), host on-campus workshops and meetups, participate in the Student-Union Discord, and contribute technically to Akash — from GitHub documentation to Console deployments.

**How can I apply to become an Akash Student Ambassador?**
Apply via the form at akash.network/community/student-ambassadors/ — applications for new cohorts open periodically. Follow @AkashStudents on X for announcements.

**Why is Akash investing in student ambassadors?**
Students are future CTOs and engineers. Building Akash fluency at the university level creates long-term ecosystem adoption as these students graduate and join or found companies.

**What early contributions did the first cohort make?**
Alex presented Akash as an AWS alternative at USC Data Science Club within the first week. Ayesha published LinkedIn content on decentralization. Helen published a piece on blockchain reshaping AI training.

**Where can student ambassadors connect with each other?**
The Akash Student-Union Discord at discord.gg/6cynyNtKz2 — and follow @AkashStudents on X for real-time updates on program activities and hackathon wins.
