...
See [Hardware Requirements](/docs/for-providers/getting-started/hardware-requirements) for detailed specifications.
...
- **Kubespray fails**: 
  - Check system requirements meet [Hardware Requirements](/docs/for-providers/getting-started/hardware-requirements)
