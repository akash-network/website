...
> **Don't need persistent storage?** Skip to [Provider Installation](/docs/for-providers/setup-and-installation/kubespray/provider-installation).
...
See [Hardware Requirements - Persistent Storage](/docs/for-providers/getting-started/hardware-requirements#persistent-storage) for detailed specifications:
...
**→ [Provider Installation](/docs/for-providers/setup-and-installation/kubespray/provider-installation)** - Install the Akash provider
