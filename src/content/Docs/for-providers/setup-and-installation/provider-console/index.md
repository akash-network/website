...
- **[Getting Started](/docs/for-providers/setup-and-installation/provider-console/getting-started)** - First-time setup
- **[Configuration](/docs/for-providers/setup-and-installation/provider-console/configuration)** - Provider settings
- **[Root Sign-In](/docs/for-providers/setup-and-installation/provider-console/root-sign-in)** - Admin access setup
...
- [Kubespray Setup →](/docs/for-providers/setup-and-installation/kubespray)
...
4. **Review operations** - See [Operations](/docs/for-providers/operations)
...
**Want more control?**
- [Provider Playbook →](/docs/for-providers/setup-and-installation/provider-playbook) - Automated with Ansible
- [Kubespray →](/docs/for-providers/setup-and-installation/kubespray) - Full manual control
