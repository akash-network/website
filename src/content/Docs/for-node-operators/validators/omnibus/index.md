...
**Security Note:** Your validator private key will be stored in the Akash deployment (encrypted in S3 bucket). Only use trusted providers. For maximum security, consider [TMKMS](/docs/for-node-operators/validators/tmkms-stunnel) instead.
...
3. Consider [TMKMS](/docs/for-node-operators/validators/tmkms-stunnel) for additional security
...
- **Monitor:** Set up [monitoring tools](/docs/for-node-operators/validators#validator-resources)
- **Security:** Consider [TMKMS](/docs/for-node-operators/validators/tmkms-stunnel)
