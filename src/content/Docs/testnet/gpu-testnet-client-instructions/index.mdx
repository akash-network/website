...
&#x20;Follow our [Keplr Walle](/docs/getting-started/token-and-wallets#keplr-wallet)t guide to create your first wallet if necessary.
...
- Most likely - if this is your first time using the Akash Console - you would need to create a certificate. Go to `Settings` and click on the `Create Certificate` button. 
![](../../assets/createCertificate.png)
- Like before, approve the transaction.
![](../../assets/approveTransaction.png)
