...
**Example:** [CLI Installation Guide](/docs/for-developers/deployment/cli/installation-guide)
...
**Example:** [Update a Deployment](/docs/for-developers/deployment/cli/common-tasks#update-a-deployment)
...
**Example:** [CLI Commands Reference](/docs/for-developers/deployment/cli/commands-reference)
...
**Internal links:**
```markdown
See the [CLI Guide](/docs/for-developers/deployment/cli).
```
...
- **[SDL Reference](/docs/for-developers/deployment/akash-sdl)** - Learn SDL syntax
- **[Examples Library](/docs/for-developers/deployment/akash-sdl/examples-library)** - 290+ deployment examples
- **[Best Practices](/docs/for-developers/deployment/akash-sdl/best-practices)** - Production deployment tips
```
...
**Not set up yet?** See [Development Environment](/docs/for-developers/contributing/development-environment)
```
