...
**Previous:** [← Quick Start](/docs/getting-started/quick-start)
...
- [**Quick Start**](/docs/getting-started/quick-start) - Deploy your first app in 10 minutes
- [**First Deployment**](/docs/getting-started/first-deployment) - Detailed deployment tutorial
...
- [Akash Forum](https://forum.akash.network) - Ask questions and share ideas
