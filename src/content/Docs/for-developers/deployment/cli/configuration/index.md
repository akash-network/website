...
- **[Commands Reference →](/docs/for-developers/cli/commands-reference)** - Learn all CLI commands
...
**Previous:** [← Installation](/docs/for-developers/cli/installation)  
**Next:** [Commands Reference →](/docs/for-developers/cli/commands-reference)
