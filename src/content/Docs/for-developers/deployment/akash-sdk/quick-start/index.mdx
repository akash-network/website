...
- **For Go:** Go 1.25.0+
- An Akash wallet with AKT tokens (get testnet tokens from the [faucet](https://faucet.sandbox-01.aksh.pw/))
...
const sdk = createChainNodeSDK({
  query: {
    baseUrl: "https://grpc.sandbox-01.aksh.pw:443", // Testnet gRPC
  },
  tx: {
    baseUrl: "https://rpc.sandbox-01.aksh.pw:443", // Testnet RPC
    signer: wallet,
    gasPrice: "0.025uakt"
  }
});
...
func main() {
    ...
    cctx := sdkclient.Context{
        ChainID: "sandbox-01",
        NodeURI: "https://rpc.sandbox-01.aksh.pw:443",
    }
...
For a complete, runnable example that ties all these steps together, see the [Examples](/docs/for-developers/deployment/akash-sdk/examples) page.
...
- **[Examples](/docs/for-developers/deployment/akash-sdk/examples)** - Real-world code examples for common tasks
- **[API Reference](/docs/for-developers/deployment/akash-sdk/api-reference)** - Complete API documentation
- **[SDL Reference](/docs/for-developers/deployment/akash-sdl)** - Stack Definition Language documentation
...
- Testnet tokens: Get from [faucet](https://faucet.sandbox-01.aksh.pw/)
