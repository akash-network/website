...
Both SDKs are generated from the [chain-sdk](https://github.com/akash-network/chain-sdk) and provide the same core functionality.
...
- **[Quick Start](/docs/for-developers/akash-sdk/quick-start)** - Get started with your first deployment
