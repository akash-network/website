...
const sdk = createChainNodeSDK({
  query: {
    baseUrl: "https://grpc.akash.network:443", // gRPC endpoint
    transportOptions: {
  ...
  tx: {
    baseUrl: "https://rpc.akash.network:443", // RPC endpoint
    signer: wallet,
    gasPrice: "0.025uakt"
  }
});
...
func main() {
    ...
    cctx := sdkclient.Context{
        ChainID: "akashnet-2",
        NodeURI: "https://rpc.akash.network:443",
    }
...
- [SDK Installation](/docs/for-developers/deployment/akash-sdk/installation)
- [Quick Start](/docs/for-developers/deployment/akash-sdk/quick-start)
- [Examples](/docs/for-developers/deployment/akash-sdk/examples)
