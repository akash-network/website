...
**For production deployments without time limits**, use the [Akash SDK](/docs/for-developers/deployment/akash-sdk) or [CLI](/docs/for-developers/deployment/cli) with your own wallet.
...
- **[SDL Reference](/docs/for-developers/deployment/akash-sdl)** - SDL syntax guide
- **[Console Documentation](/docs/for-developers/deployment/akash-console)** - Console overview
