  ...
  examples={[
    {
      language: "typescript",
      label: "TypeScript",
      code: `npm install @akashnetwork/chain-sdk@alpha @cosmjs/proto-signing @cosmjs/amino`
    },
    {
      language: "go",
...
For a complete, runnable example that ties all these steps together, see the [Examples](/docs/api-documentation/sdk/examples) page.
...
- **[Examples](/docs/api-documentation/sdk/examples)** - Real-world code examples for common tasks
