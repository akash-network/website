...
- `generateManifest(sdl)` - Generate manifest and deployment groups
...
- [SDK Installation](/docs/api-documentation/sdk/installation)
- [Quick Start](/docs/api-documentation/sdk/quick-start)
- [Examples](/docs/api-documentation/sdk/examples)
