...
**→ [SDK Installation Guide](/docs/api-documentation/sdk/installation)**
...
- **[SDK Installation](/docs/api-documentation/sdk/installation)** - Get started with the SDK
- **[SDK Quick Start](/docs/api-documentation/sdk/quick-start)** - Deploy your first app programmatically
- **[SDK Examples](/docs/api-documentation/sdk/examples)** - More SDK code examples

---

## Additional Resources

- **Cosmos SDK AuthZ:** [docs.cosmos.network/v0.53/build/modules/authz](https://docs.cosmos.network/v0.53/build/modules/authz)
- **Cosmos SDK FeeGrant:** [docs.cosmos.network/v0.53/build/modules/feegrant](https://docs.cosmos.network/v0.53/build/modules/feegrant)
