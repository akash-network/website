...
* Go to the [Praetor Application](https://akash.praetorapp.com/) to begin the setup.
...
If you have any issues or trouble getting the provider machine up and running, ypu may reach out to the [Praetor](https://praetorapp.com) contact  on [Discord](https://discord.com/invite/uzUCHTF93D) or [Twitter/X](https://x.com/praetor_app).
