...
linkTitle: Sandbox Installation
---
...
- [Sandbox Faucet](https://faucet.sandbox-2.aksh.pw/)

### Expected Result

- The following, example screen will appear if funding from the faucet was successful:

![faucet screenshot](../../../assets/testnet_faucet_transaction.png)
...
| AKASH_GAS_ADJUSTMENT | Adjustment factor to be multiplied against the estimate returned by the tx simulation     | `1.5`             |
...
Create a deployment configuration [deploy.yaml](https://github.com/akash-network/docs/tree/b65f668b212ad1976fb976ad84a9104a9af29770/guides/deploy/deploy.yml) to deploy the `ovrclk/lunie-light` for [Lunie Light](https://github.com/ovrclk/lunie-light) Node app container using [SDL](../../../getting-started/stack-definition-language).

### Modify your Configuration

You may use the sample deployment file as-is or modify it for your own needs as described in our [SDL (Stack Definition Language)](../../../getting-started/stack-definition-language) documentation. A typical modification would be to reference your own image instead of our demo app image.
