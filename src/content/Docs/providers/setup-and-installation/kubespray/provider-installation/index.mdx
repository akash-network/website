...
> **Note:** `akash-node-1-0` appears only if you run your own akash-node ([prep STEP 5, Option B](/docs/providers/setup-and-installation/kubespray/provider-installation-prep#step-5---configure-chain-rpc-access)). Providers using a public RPC endpoint will not have this pod.
