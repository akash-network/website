...
### [IP Operator](/docs/providers/architecture/operators/ip)
Manages static IP address allocation for deployments via MetalLB integration.

### [Hostname Operator](/docs/providers/architecture/operators/hostname)
...
- [Manifest Service](/docs/providers/architecture/manifest-service) - Manifest handling
