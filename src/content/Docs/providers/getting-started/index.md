...
tags: ["Getting Started", "Provider", "Setup"]
weight: 1
title: "Getting Started as a Provider"
linkTitle: "Getting Started"
---

**Everything you need to know before running an Akash provider.**

This section helps you evaluate whether running a provider is right for you and prepare for setup.

---

## In This Section

### [Should I Run a Provider?](/docs/providers/getting-started/should-i-run-a-provider)
Evaluate if running a provider makes sense for your situation.
