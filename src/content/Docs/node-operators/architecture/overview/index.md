...
- **[Consensus Layer](/docs/node-operators/architecture/consensus-layer)** - CometBFT consensus, block production, P2P networking
- **[Application Layer](/docs/node-operators/architecture/application-layer)** - Cosmos SDK modules, Akash modules, state management
- **[API Layer](/docs/node-operators/architecture/api-layer)** - gRPC, REST, RPC interfaces and examples
...
**→ [Learn more about Application Layer](/docs/node-operators/architecture/application-layer)**
...
**→ [Learn more about API Layer](/docs/node-operators/architecture/api-layer)**
...
- [Build a Node](/docs/node-operators/node-build)
