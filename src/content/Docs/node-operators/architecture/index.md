...
### [Overview](/docs/node-operators/architecture/overview)

High-level overview of node architecture, responsibilities, state management, and how all components work together.

### [Consensus Layer](/docs/node-operators/architecture/consensus-layer)
...
### [Application Layer](/docs/node-operators/architecture/application-layer)
...
### [API Layer](/docs/node-operators/architecture/api-layer)
