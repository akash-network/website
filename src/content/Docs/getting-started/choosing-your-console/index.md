...
- **No** → [Akash Console](https://console.akash.network). Sign up with your email and start deploying; add a card when you want to go past the trial. Begin with the [Quick Start](/docs/getting-started/quick-start).
