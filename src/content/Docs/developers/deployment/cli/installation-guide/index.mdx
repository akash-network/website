...
Use **[mainnet `meta.json`](https://raw.githubusercontent.com/akash-network/net/main/mainnet/meta.json)** as the source for chain ID and RPC endpoints (`curl` and **`jq`** required).
