...
See **[AuthZ & Fee Grants SDK](/docs/extend/sdk/authz-feegrant)** for programmatic usage with Go and JavaScript/TypeScript.
...
**→ [AuthZ & Fee Grants SDK Documentation](/docs/extend/sdk/authz-feegrant)**
...
- **[SDK Documentation](/docs/extend/sdk)** - Programmatic AuthZ usage
