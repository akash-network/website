...
### [Getting Started with Console](/docs/developers/deployment/akash-console/getting-started)
...
**New to Akash?**  
→ [Free Trial Quick Start](/docs/getting-started/quick-start) - Deploy in 10 minutes with $1 free credits
