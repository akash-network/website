...
- **For Go:** Go 1.25.0+
- An Akash wallet with AKT tokens (get sandbox tokens from the [faucet](https://faucet.sandbox-2.aksh.pw/))
...
- Sandbox tokens: Get from [faucet](https://faucet.sandbox-2.aksh.pw/)
