...
1. **Set up the website repository:**
   - Follow the [Console & Website Setup Guide](/docs/developers/contributing/console-website-setup)
   - Quick version:
   ```bash
...
**Important:** Node and provider development requires a complete Kubernetes environment and is significantly more complex than other contributions. New contributors should start with documentation or Console contributions first. See the complete [Development Environment Guide](/docs/developers/contributing/development-environment) for detailed setup instructions.
...
**See:** [Code Conventions](/docs/developers/contributing/code-conventions)
...
- **[Development Environment](/docs/developers/contributing/development-environment)** - Deep dive into setup
- **[Pull Request Process](/docs/developers/contributing/pull-request-process)** - Detailed PR guide
