...
title: "Contributing to Akash Network"
linkTitle: "Contributing"
description: "Get involved in Akash Network development and contribute to the codebase"
---
...
**See:** [Documentation Writing Guide](/docs/developers/contributing/documentation-guide)

### Community Contributions

Help others in the community:

- Answer questions in [Discord](https://discord.akash.network)
...
**Code:**
- [Console & Website Setup](/docs/developers/contributing/console-website-setup) - Web development (recommended for beginners)
- [Node & Provider Setup](/docs/developers/contributing/development-environment) - Blockchain development (advanced)
- [Code Conventions](/docs/developers/contributing/code-conventions)
- [Pull Request Process](/docs/developers/contributing/pull-request-process)

**Documentation:**
- [Documentation Writing Guide](/docs/developers/contributing/documentation-guide)
- [Console & Website Setup](/docs/developers/contributing/console-website-setup)
- [Pull Request Process](/docs/developers/contributing/pull-request-process)

**Community:**
- Join [Discord](https://discord.akash.network)
- Explore [Awesome Akash](https://github.com/akash-network/awesome-akash)
- Read the [Blog](/blog)
...
- Follow [Console & Website Setup](/docs/developers/contributing/console-website-setup)
...
- GitHub: [website issues](https://github.com/akash-network/website/issues)
...
1. **Pick a section:**
   - [Getting Started](/docs/developers/contributing/getting-started)
   - [Console & Website Setup](/docs/developers/contributing/console-website-setup) - For web development
   - [Node & Provider Setup](/docs/developers/contributing/development-environment) - For blockchain development
   - [Documentation Guide](/docs/developers/contributing/documentation-guide)
   - [Code Conventions](/docs/developers/contributing/code-conventions)
   - [Pull Request Process](/docs/developers/contributing/pull-request-process)
