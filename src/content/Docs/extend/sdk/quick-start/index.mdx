...
For a complete, runnable example that ties all these steps together, see the [Examples](/docs/extend/sdk/examples) page.
...
- **[Examples](/docs/extend/sdk/examples)** - Real-world code examples for common tasks
