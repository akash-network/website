...
<h1 class="text-center !m-0  md:!leading-10 text-2xl lg:text-[32px]">The Akash Network is open source and operates under an open development framework. There are a number of ways for individuals or teams to be financially compensated for contributions to the network.</h1>
