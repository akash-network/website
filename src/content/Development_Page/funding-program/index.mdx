...
<h1 class="text-[32px] font-semibold leading-10 mx-auto max-w-[1155px] text-center">The Akash Network is open source and operates under an open development framework. There are a number of ways for individuals or teams to be financially compensated for contributions to the network.</h1>
