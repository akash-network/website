...
<div class="bg-background2 border rounded-lg p-4 mb-10 mt-5 flex flex-col gap-4 ">
  <iframe
    class="w-full "
    src={`https://calendar.google.com/calendar/embed?src=c_25e5e3748e4c4ab7a55f41fbc5ebebcc0a03b40fb028785f14159bfaebea12e2%40group.calendar.google.com&ctz=${Intl.DateTimeFormat().resolvedOptions().timeZone}&mode=AGENDA&amp`}
    style="border: 0"
    width="800"
    height="600"
    frameborder="0"
