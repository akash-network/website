...
import { Pricing } from "../about-pages/pricing/pricing";
...
export const Tables = ({
  ...
  const [selected, setSelected] = useState<'GPU Pricing' | 'Usage Pricing Calculator'>('GPU Pricing');
  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center items-center">
        <h1 className="text-[48px] font-bold mb-5">Pricing</h1>
        ...
        <div className="flex w-full justify-center">
          <div className={`rounded-[10px] p-1 bg-black text-white dark:bg-[#ededed] dark:text-black`}>
            <button
              className={`text-lg font-bold px-4 py-1 rounded-[8px] ${selected === "GPU Pricing" ? "bg-white text-black dark:bg-[#1c1c1c] dark:text-white" : ""}`}
              onClick={() => setSelected('GPU Pricing')}
            >
              GPU Pricing
            </button>
            <button
              className={`text-lg font-bold rounded-[8px] px-4 py-1 ${selected === "GPU Pricing" ? "" : "bg-white text-black dark:bg-[#1c1c1c] dark:text-white"}`}
              onClick={() => setSelected('Usage Pricing Calculator')}
            >
