        ...
        >
            ...
            <div className="flex flex-col gap-2 w-full">
                ...
                <div className="md:rounded-md md:border md:p-6 md:shadow-sm md:bg-background2">
                    <div className="border rounded-md md:border-b md:border-l-0 md:border-t-0 md:border-r-0 p-4 md:pb-7 bg-background2">
                        <PricingUnit
                    ...
                    <div className="mt-8 md:mt-0 border rounded-md md:border-none p-4 md:pt-4  bg-background2">
