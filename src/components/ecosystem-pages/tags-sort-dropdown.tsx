  ...
  return (
    <Menu as="div" className="relative inline-block text-left">
      <div className="flex items-center gap-x-2">
        ...
        <Menu.Button className="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-background2 px-3 py-2 text-sm font-semibold text-foreground shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 dark:hover:bg-darkGray">
          {currentSort}
          <ChevronDownIcon
        ...
        <Menu.Items className="absolute right-0 z-10 mt-4 w-40 origin-top-right divide-y divide-gray-100 rounded-lg border  bg-background2 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          <div className="space-y-1 px-2 py-3">
            <Menu.Item>
              {({ active }) => (
                <a
                  href={`/ecosystem/${currentPath.split("/")[2]}/${
                    currentPath.split("/")[3]
                  }/latest/1`}
                  className="block"
                >
